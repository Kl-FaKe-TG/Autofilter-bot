...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, START_MESSAGE, FORCE_SUB_TEXT, SUPPORT_CHAT, FORCE_IMG
...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('📢Ott Updates', url='https://t.me/cinema_flix_updates'),
    ...
    if settings is not None:
        buttons = [
            [
                ...
                InlineKeyboardButton(
                    '𝐒𝐢𝐧𝐠𝐥𝐞' if settings["button"] else '𝐃𝐨𝐮𝐛𝐥𝐞',
                    callback_data=f'setgs#button#{settings["button"]}#{grp_id}',
                ),
            ],
            [
            ...
            [
                ...
                InlineKeyboardButton(
                    '√ 𝐘𝐞𝐬' if settings["file_secure"] else '⛌ 𝐍𝐨',
                    callback_data=f'setgs#file_secure#{settings["file_secure"]}#{grp_id}',
                ),
            ],
            [
            ...
            [
                ...
                InlineKeyboardButton(
                    '√ 𝐘𝐞𝐬' if settings["spell_check"] else '⛌ 𝐍𝐨',
                    callback_data=f'setgs#spell_check#{settings["spell_check"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '√ 𝐘𝐞𝐬' if settings["welcome"] else '⛌ 𝐍𝐨',
                    callback_data=f'setgs#welcome#{settings["welcome"]}#{grp_id}',
                ),
            ],
        ]
        ...
        await message.reply_text(
            text=f"<b>𝖼𝗁𝖺𝗇𝗀𝖾 𝗒𝗈𝗎𝗋 𝗌𝖾𝗍𝗍𝗂𝗇𝗀𝗌 𝖿𝗈𝗋 {title} 𝖺𝗌 𝗒𝗈𝗎𝗋 𝗐𝗂𝗌𝗁 ⚙</b>",
            reply_markup=reply_markup,
